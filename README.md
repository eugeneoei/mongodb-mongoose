...
I've not built an app with `mongodb` and `mongoose` as the driver. so I'm definitely not in the position to say if method A is better than method B/C/D.. and so on.
